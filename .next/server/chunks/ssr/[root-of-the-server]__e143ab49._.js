...
}`})})})]}),(0,b.jsxs)("section",{className:"mb-12",children:[(0,b.jsx)("h2",{className:"text-2xl font-bold mb-6",children:"Features"}),(0,b.jsxs)("div",{className:"grid md:grid-cols-2 gap-4",children:[(0,b.jsxs)("div",{className:"bg-card border border-border rounded-lg p-6",children:[(0,b.jsx)(f.Code2,{className:"h-8 w-8 text-primary mb-3"}),(0,b.jsx)("h3",{className:"font-semibold mb-2",children:"Swift Concurrency"}),(0,b.jsx)("p",{className:"text-sm text-muted-foreground",children:"Built with async/await for modern Swift apps"})]}),(0,b.jsxs)("div",{className:"bg-card border border-border rounded-lg p-6",children:[(0,b.jsx)(g.Zap,{className:"h-8 w-8 text-primary mb-3"}),(0,b.jsx)("h3",{className:"font-semibold mb-2",children:"SwiftUI Ready"}),(0,b.jsx)("p",{className:"text-sm text-muted-foreground",children:"Seamless integration with SwiftUI views"})]}),(0,b.jsxs)("div",{className:"bg-card border border-border rounded-lg p-6",children:[(0,b.jsx)(h.Shield,{className:"h-8 w-8 text-primary mb-3"}),(0,b.jsx)("h3",{className:"font-semibold mb-2",children:"Type-Safe"}),(0,b.jsx)("p",{className:"text-sm text-muted-foreground",children:"Full type safety with Swift's strong typing"})]}),(0,b.jsxs)("div",{className:"bg-card border border-border rounded-lg p-6",children:[(0,b.jsx)(e.Package,{className:"h-8 w-8 text-primary mb-3"}),(0,b.jsx)("h3",{className:"font-semibold mb-2",children:"Multi-Platform"}),(0,b.jsx)("p",{className:"text-sm text-muted-foreground",children:"iOS, macOS, watchOS, and tvOS support"})]})]})]}),(0,b.jsxs)("section",{className:"mb-12",children:[(0,b.jsx)("h2",{className:"text-2xl font-bold mb-4",children:"SwiftUI Integration"}),(0,b.jsx)("div",{className:"bg-card border border-border rounded-lg p-6",children:(0,b.jsx)("pre",{className:"text-sm overflow-x-auto",children:(0,b.jsx)("code",{className:"text-foreground",children:`import SwiftUI
import TaxuSDK
...
let document = try await taxu.documents.upload(
    ...
    type: .w2,
    taxYear: 2024
)`})})})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("h3",{className:"text-lg font-semibold mb-3",children:"Streaming AI Chat"}),(0,b.jsx)("div",{className:"bg-card border border-border rounded-lg p-6",children:(0,b.jsx)("pre",{className:"text-sm overflow-x-auto",children:(0,b.jsx)("code",{className:"text-foreground",children:`let stream = try await taxu.ai.chatStream(
...
print() // New line after stream completes`})})})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("h3",{className:"text-lg font-semibold mb-3",children:"Combine Publishers"}),(0,b.jsx)("div",{className:"bg-card border border-border rounded-lg p-6",children:(0,b.jsx)("pre",{className:"text-sm overflow-x-auto",children:(0,b.jsx)("code",{className:"text-foreground",children:`import Combine
...
`})})})]})]})]}),(0,b.jsxs)("section",{className:"mb-12",children:[(0,b.jsx)("h2",{className:"text-2xl font-bold mb-4",children:"Error Handling"}),(0,b.jsx)("div",{className:"bg-card border border-border rounded-lg p-6",children:(0,b.jsx)("pre",{className:"text-sm overflow-x-auto",children:(0,b.jsx)("code",{className:"text-foreground",children:`do {

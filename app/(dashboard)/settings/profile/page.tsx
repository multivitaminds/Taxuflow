    ...
    <div className="space-y-10">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {[
            { name: "Tax Filing", status: "active", description: "2024 returns in progress" },
            { name: "Neobank", status: "active", description: "Checking account active" },
            { name: "Investment", status: "inactive", description: "Not configured" },
            { name: "Accounting", status: "active", description: "QuickBooks connected" },
          ].map((product) => (
            <div
              key={product.name}

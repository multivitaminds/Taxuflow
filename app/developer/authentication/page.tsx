  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="max-w-4xl mx-auto px-24 py-12">
        ...
        {/* API Keys */}
        <div className="rounded-2xl border-0 shadow-lg bg-white/80 backdrop-blur p-8 mb-6">
        ...
        <div className="rounded-2xl border-0 shadow-lg bg-gradient-to-br from-blue-50 to-indigo-50 p-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-3 rounded-xl bg-gradient-to-br from-blue-600 to-indigo-600 shadow-lg">

          ...
          <table className="w-full">
            <thead>
              <tr className="border-b">
                ...
                <th className="text-right py-3 px-4">Total Invoiced</th>
            ...
            <tbody>
              <tr className="border-b hover:bg-muted/50">
                ...
                <td className="text-right py-3 px-4">$45,200.00</td>
                <td className="text-right py-3 px-4">$32,500.00</td>
                <td className="text-right py-3 px-4 font-medium">$12,700.00</td>
                <td className="text-right py-3 px-4">$50,000.00</td>
              </tr>
              <tr className="border-b hover:bg-muted/50">
                <td className="py-3 px-4">TechStart Inc</td>
                <td className="text-right py-3 px-4">$38,500.00</td>
                <td className="text-right py-3 px-4">$28,000.00</td>
                <td className="text-right py-3 px-4 font-medium">$10,500.00</td>
                <td className="text-right py-3 px-4">$40,000.00</td>
              </tr>
              <tr className="border-b hover:bg-muted/50">
                <td className="py-3 px-4">Global Solutions</td>
                <td className="text-right py-3 px-4">$52,840.00</td>
                <td className="text-right py-3 px-4">$33,840.00</td>
                <td className="text-right py-3 px-4 font-medium text-red-600">$19,000.00</td>
                <td className="text-right py-3 px-4">$60,000.00</td>
              </tr>
              <tr className="border-b hover:bg-muted/50">
                <td className="py-3 px-4">Innovation Labs</td>
                <td className="text-right py-3 px-4">$34,000.00</td>
                <td className="text-right py-3 px-4">$34,000.00</td>
                <td className="text-right py-3 px-4 font-medium text-green-600">$0.00</td>
                <td className="text-right py-3 px-4">$35,000.00</td>
              </tr>
              <tr className="font-bold bg-muted/30">
                <td className="py-3 px-4">Total</td>
                <td className="text-right py-3 px-4">$170,540.00</td>
                <td className="text-right py-3 px-4">$128,340.00</td>
                <td className="text-right py-3 px-4">$42,200.00</td>
                <td className="text-right py-3 px-4">$185,000.00</td>
              </tr>
            </tbody>
          </table>
        </div>
